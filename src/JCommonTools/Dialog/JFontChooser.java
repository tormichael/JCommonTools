...
public class JFontChooser extends JComponent
{
	...
	public JFontChooser(String[] fontSizeStrings)
	{
		...
		messageCatalog = ResourceBundle.getBundle(CC.CT_RESOURCE_TEXT);
	...
	protected class DialogOKAction extends AbstractAction
	{
		...
		protected DialogOKAction(JDialog dialog)
		{
			...
			putValue(Action.NAME, _("Text.OK"));
		}
	...
	protected class DialogCancelAction extends AbstractAction
	{
		...
		protected DialogCancelAction(JDialog dialog)
		{
			...
			putValue(Action.DEFAULT, ACTION_NAME);
			putValue(Action.ACTION_COMMAND_KEY, ACTION_NAME);
			putValue(Action.NAME, _("Text.Cancel"));
		}
	...
	protected JDialog createDialog(Component parent)
	{
		...
		JDialog dialog = new JDialog(frame, _("JFontChooser.SelectFont"), true);
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			JLabel label = new JLabel(_("JFontChooser.FontName"));
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			JLabel label = new JLabel(_("JFontChooser.FontStyle"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			JLabel label = new JLabel(_("JFontChooser.FontSize"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel()
	{
		if (samplePanel == null)
		{
			Border titledBorder = BorderFactory.createTitledBorder(
				BorderFactory.createEtchedBorder(), _("JFontChooser.Sample"));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText = new JTextField(_("JFontChooser.SampleString"));
	...
	protected String[] getFontStyleNames()
	{
		if (fontStyleNames == null)
		{
			...
			fontStyleNames[i++] = _("JFontChooser.Plain");
			fontStyleNames[i++] = _("JFontChooser.Bold");
			fontStyleNames[i++] = _("JFontChooser.Italic");
			fontStyleNames[i++] = _("JFontChooser.BoldItalic");
		}
